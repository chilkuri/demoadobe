...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "chilkuri-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/demoadobe"
  #   chef.validation_client_name = "demoadobe-validator"
  #   chef.validation_key_path = ".chef/demoadobe-validator.pem"
  # end
end
